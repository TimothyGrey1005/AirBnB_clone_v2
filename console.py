#!/usr/bin/python
"""
Defines the Module for HBNB console
"""
import cmd
import re
import shlex
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, arg):
        """
        Create a new class instance of BaseModel and save it to the JSON file.
        Usage: create <class_name> <key 1>=<value 2> <key 2>=<value 2> 
        """
        try:
    ...
    def do_show(self, arg):
        """
        Show string representation of a class instance.
    ...
    def do_destroy(self, arg):
        """
        Delete a class instance based on the name and id of the class.
    ...
    def do_all(self, arg):
        """
        Print the string representation of all class instances or a specific class.
        Usage: <User>.all()
                <User>.show()
        """
        objects = storage.all()
    ...
    def do_count(self, arg):
        """
        Counts and gets the number of instances of a class
    ...
    def do_update(self, arg):
        """
        Update an instance by adding or modifying attribute.
    ...
    def default(self, arg):
        """
        Default behavior for cmd module when the input is incorrect
        """
        arg_list = arg.split('.')
