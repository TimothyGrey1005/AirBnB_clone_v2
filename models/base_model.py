...
class BaseModel:
    ...
    def save(self):
        """Update the updated_at var with the current datetime."""
    ...
    def to_dict(self):
        """
        This function returns a dictionary representation of the BaseModel instance.
    ...
    def delete(self):
        """This function deletes the current instance from storage."""
        models.storage.delete(self)

    def __str__(self):
        """This function returns the print/str representation of the BaseModel instance."""
