...
class Place(BaseModel, Base):
    """This class represents a Place for a MySQL database.

    It inherits from the SQLAlchemy Base and then links to the MySQL places table.

    Attributes:
        __tablename__ (str): The MySQL table name to store places.
    ...
    if getenv("HBNB_TYPE_STORAGE", None) != "db":
        @property
        def reviews(self):
            """This function gets a list of all linked Reviews."""
            review_list = []
        ...
        @property
        def amenities(self):
            """This function  gets/sets linked Amenities."""
            amenity_list = []
